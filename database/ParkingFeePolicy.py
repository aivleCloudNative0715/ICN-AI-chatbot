...
PARKING_FEE_API_URL = os.getenv("PARKING_FEE_API_URL")

if not PARKING_FEE_API_KEY:
    raise ValueError("PARKING_FEE_API_KEY 환경 변수가 설정되지 않았습니다. .env 파일을 확인하세요.")
...
params = {
    'serviceKey': PARKING_FEE_API_KEY,
    'numOfRows': '100',
    'pageNo': '1',
    'type': 'json'
}
...
charge_name_map = {
    "NF00000001": "단기", "NF00000002": "장기소형", "NF00000003": "장기대형",
    "NF00000004": "화물소형", "NF00000005": "화물대형", "NF00000007": "화물대형할인후",
    "NF00000008": "화물대형(할인X)", "NF00000009": "주차대행(프리미엄)", "NF00000010": "예약P5(하얏트전면)",
    "FB00000001": "단기", "FB00000002": "장기소형", "FB00000003": "장기대형",
    "FB00000004": "화물소형", "FB00000005": "화물대형", "FB00000006": "무료",
    "FB00000007": "화물대형할인", "FB00000008": "주차대행(프리미엄)", "FB00000009": "예약P5(하얏트전면)",
    "FB00000010": "예약P5(하얏트전면) 무료"
}
